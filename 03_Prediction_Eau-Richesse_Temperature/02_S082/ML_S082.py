...
# #Compraison des modèles
# from sklearn.ensemble import RandomForestRegressor

# model_rf = Pipeline([("reg", RandomForestRegressor(n_estimators=100, random_state=0, n_jobs=-1))])

# cv_res_rf = cross_validate(model_rf, X, y, cv=cv, groups=groups, scoring=scoring)

# mae_rf = -cv_res_rf["test_mae"].mean()
# rmse_rf = -cv_res_rf["test_rmse"].mean()
# r2_rf = cv_res_rf["test_r2"].mean()

# print("\n" + "="*60)
# print("🏆 COMPARAISON MODÈLES")
# print("="*60)
# print(f"Ridge         → R²={r2_test.mean():.3f}  MAE={mae_test.mean():.1f}°C")
# print(f"RandomForest  → R²={r2_rf:.3f}       MAE={mae_rf:.1f}°C")
# print(f"🎯 GAGNANT    : {'RandomForest' if r2_rf > r2_test.mean() else 'Ridge'}")
# print("="*60)
...
plt.savefig('presentation_modele.png', dpi=300, bbox_inches='tight', facecolor='white')
plt.show()
print("✅ PRÉSENTATION SAUVEGARDÉE : presentation_modele.png")
