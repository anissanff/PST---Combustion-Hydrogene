...
# # -----------------------------
# # COMPARAISON RandomForest vs Ridge
# # -----------------------------
# from sklearn.ensemble import RandomForestRegressor

# # MODÈLE RandomForest (PAS de scaler nécessaire)
# model_rf = Pipeline(steps=[
#     ("reg", RandomForestRegressor(n_estimators=100, random_state=0, n_jobs=-1))
# ])

# # MÊME CrossVal que Ridge
...
# # Entraîner RF final (comme Ridge)
# model_rf.fit(X, y)
